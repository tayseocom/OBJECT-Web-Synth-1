...
export const BUILT_IN_PRESETS: BuiltInPreset[] = [
  ...
  },
  {
    ...
    params: { strike: 0.24, pickup: 0.28, coupling: 0.58, damping: 0.82, tracking: 0.72, spread: 0.42, edge: 0.08 },
  ...
  },
  {
    ...
    params: { strike: 0.2, pickup: 0.7, coupling: 0.22, damping: 0.76, tracking: 0.9, spread: 0.34, edge: 0.02 },
    exciter: "breath", body1: "membrane", body2: "plate", body2On: true, poly: "16", mode: "Poly",
    fx: { chorus: 0.26, delay: 0.18, space: 0.58 }, motionTarget: "coupling", motionRate: "0.08",
  },
  {
    name: "Rubber Mallet",
  ...
  },
  {
    ...
    params: { strike: 0.38, pickup: 0.7, coupling: 0.3, damping: 0.48, tracking: 1, spread: 0.34, edge: 0.22 },
